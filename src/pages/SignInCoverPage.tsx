...
const SignInCoverPage = () => {
  ...
  return (
    <>
      <div className="row g-0 flex-fill min-vh-100">
        <div className="col-12 col-lg-6 col-xl-4 border-top-wide border-primary d-flex flex-column justify-content-center min-vh-100">
          <div className="container container-tight py-4 my-0 my-lg-5 px-lg-5">
          <div className="text-center mb-4">
            <Link to="/dashboard" aria-label="Tabler" className="navbar-brand navbar-brand-autodark">
          ...
          <form
            ...
            onSubmit={(event) => {
              ...
              navigate("/2-step-verification-code");
            }}
          >
              ...
              <div className="mb-2">
                ...
                <div className="input-group input-group-flat">
                  ...
                  <span className="input-group-text">
                    <span className="link-secondary" title="Show password">
                      <svg
              ...
              <div className="mb-2">
                <label className="form-check">
                  ...
                  <span className="form-check-label">
                    I agree to the terms of service, <Link to="/terms-of-service">click here</Link>
                  </span>
                </label>
              </div>
        ...
        <div className="col-12 col-lg-6 col-xl-8 d-none d-lg-block">
          <div
            ...
            style={{ backgroundImage: "url(/static/photos/finances-us-dollars-and-bitcoins-currency-money-2.jpg)" }}
          ></div>
        </div>
      </div>
