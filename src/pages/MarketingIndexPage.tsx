...
const MarketingIndexPage = () => {
  ...
  return (
        ...
        <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
          <nav className="navbar-nav ms-auto">
            <div className="nav-item">
              <a className="nav-link active" href="/"><span className="nav-link-title">Home</span></a>
            </div>
            <div className="nav-item">
              <a className="nav-link" href="/marketing-testimonials"><span className="nav-link-title">Testimonials</span></a>
            </div>
            <div className="nav-item">
              <a className="nav-link" href="/marketing-pricing"><span className="nav-link-title">Pricing</span></a>
            </div>
            <div className="nav-item">
              <a className="nav-link" href="../marketing/about.html"><span className="nav-link-title">About</span></a>
            </div>
            <div className="nav-item">
              <a className="nav-link" href="/marketing-text"><span className="nav-link-title">Text</span></a>
            </div>
            <div className="nav-item">
              <a className="nav-link" href="/dashboard"><span className="nav-link-title">App</span></a>
            </div>
            <div className="nav-item">
              <a className="nav-link" href="../marketing/real-estate.html"><span className="nav-link-title">Real estate</span></a>
            </div>
            <div className="nav-item ms-lg-4">
              <div className="d-flex flex-row gap-2 align-items-center">
                <a href="/sign-up" className="btn btn-outline-primary">Signup</a>
                <div className="dropdown dropdown-hover">
                  <a className="btn btn-primary dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Login
                  </a>
                  <div className="dropdown-menu dropdown-menu-start">
                    <a className="dropdown-item" href="/sign-in">School Login</a>
                    <a className="dropdown-item" href="/sign-in">College Login</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="container">
        ...
        <div className="my-5">
          <div className="row g-3 justify-content-center">
            ...
            <div className="col-auto">
              <a href="#" className="btn btn-lg btn-primary" target="_blank" rel="noopener noreferrer">Preview template</a>
            </div>
          </div>
        </div>
                ...
                <div className="col-8">
                  ...
                  >
                    ...
                    <svg
                      ...
                      className="icon me-2 text-green icon-sm"
                    >
    ...
    <section className="section section-light mt-n12 pt-12">
      <svg className="section-divider" xmlns="http://www.w3.org/2000/svg" viewBox="0 24 150 28" preserveAspectRatio="none">
        <path className="wave-1" d="M-110 44c30 0 58-18 88-18s 58 18 88 18 58-18 88-18 58 18 88 18 v44h-352z"></path>
        <path className="wave-2" d="M-110 44c30 0 58-18 88-18s 58 18 88 18 58-18 88-18 58 18 88 18 v44h-352z"></path>
        <path className="wave-3" d="M-110 44c30 0 58-18 88-18s 58 18 88 18 58-18 88-18 58 18 88 18 v44h-352z"></path>
      </svg>
      <div className="container">
        ...
        <div className="row g-lg-8 align-items-center justify-content-center">
          <div className="col-auto">
            <a href="#" className="link-secondary"
              ><svg width="188" height="28" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div className="col-auto">
            <a href="#" className="link-secondary"
              ><svg width="57" height="27" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div className="col-auto">
            <a href="#" className="link-secondary"
              ><svg width="157" height="28" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div className="col-auto">
            <a href="#" className="link-secondary"
              ><svg width="89" height="30" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <a href="#" className="link-secondary"
              ><svg width="94" height="41" xmlns="http://www.w3.org/2000/svg">
                <g fillRule="nonzero" fill="none">
                  <path d="M14.137 29.518L18.564 4.83 3.353 3.353 5.51 30.17l8.627-.652zM4.922 41l-1.071-8.922 14.796 3.245L4.922 41z" fill="currentColor" />
                  <path
                    ...
                    fill="#FFF"
                  />
                  <path stroke="currentColor" strokeWidth=".515" fill="#FFF" d="M11.85 8.059l-.262 26.85.624.209.79-23.725 5.645-1.22z" />
                  <path
          ...
          <div className="col-auto">
            <a href="#" className="link-secondary"
              ><svg width="91" height="30" xmlns="http://www.w3.org/2000/svg">
                <g fill="currentColor" fillRule="evenodd">
                  <path
      ...
      <div className="container">
        <div className="row items-center text-center g-lg-10">
          <div className="col-md-6 col-lg">
            <div className="shape shape-md mb-3">
            ...
            <p className="text-secondary">Our email templates are fully responsive, so you can be sure they will look great on any device and screen size.</p>
          </div>
          <div className="col-md-6 col-lg">
            <div className="shape shape-md mb-3">
          ...
          <div className="col-md-6 col-lg">
            ...
            <p className="text-secondary">Draw recipients’ attention with beautiful, minimal email designs based on Bootstrap and Material Design principles.</p>
          </div>
        </div>
      </div>
    </section>
            ...
            <div className="space-y-6">
              <div>
                <div className="row">
                  ...
                  <div className="col">
                    <h3 className="h2 mb-2">Designed with users in mind</h3>
                    <p className="text-secondary m-0">
                      Tabler is fully responsive and compatible with all modern browsers. Thanks to its modern, user-friendly design you can create a fully
                      functional interface that users will love. Every UI element has been created with attention to detail to make your interface beautiful!
                    </p>
                  </div>
                </div>
              </div>
              <div>
                <div className="row">
                  ...
                  <div className="col">
                    <h3 className="h2 mb-2">Built for developers</h3>
                    <p className="text-secondary m-0">
                      ...
                      Based on Bootstrap 5, Tabler is a cutting-edge solution, compatible with all modern browsers and fully responsive.
                    </p>
                  </div>
                </div>
              </div>
              <div>
                <div className="row">
                  ...
                  <div className="col">
                    <h3 className="h2 mb-2">Fully customizable</h3>
                    <p className="text-secondary m-0">
                      You can easily customize the UI elements to make them fit the needs of your project. And don’t worry if you don’t have much experience -
    ...
    <section className="section">
      <div className="container-narrow text-center">
        ...
        <p className="text-secondary">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, ipsa? Voluptates sunt, ipsum esse quis obcaecati atque placeat consectetur beatae,
        ...
        <div className="btn-list justify-content-center mt-6">
          <a href="#" className="btn btn-primary btn-2"> Get started </a>
          <a href="#" className="btn btn-3">
            ...
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="icon icon-end icon-2"
            >
            ...
            <div className="row g-lg-6">
                ...
                <a href="#" className="card bg-surface-secondary">
                  <div className="card-body">
                    <div className="row mb-3">
                      <div className="col-auto"><span className="avatar avatar-md" style={{ backgroundImage: "url(../static/avatars/052f.jpg)" }}> </span></div>
                      <div className="col">
                        <h3 className="h3 m-0">Jeffie Lewzey</h3>
                        <div className="text-secondary">Chemical Engineer</div>
                      </div>
                    </div>
                    <p>
                      Ever since I started using Tabler, my HTML designing process has been significantly smoother. Its intuitive interface is a breath of fresh
                      air!
                    </p>
                  </div>
                </a>
              ...
              <div className="col-12">
                <a href="#" className="card bg-surface-secondary">
                  <div className="card-body">
                    <div className="row mb-3">
                      <div className="col-auto"><span className="avatar avatar-md" style={{ backgroundImage: "url(../static/avatars/002m.jpg)" }}> </span></div>
                      <div className="col">
                        <h3 className="h3 m-0">Mallory Hulme</h3>
                        <div className="text-secondary">Geologist IV</div>
                      </div>
                    </div>
                    <p>
                      I'm beyond impressed with Tabler. This UI kit has transformed my workflow for the better. It's easy to use, streamlined, and remarkably
                      efficient.
                    </p>
                  </div>
                </a>
              ...
              <div className="col-12">
                <a href="#" className="card bg-surface-secondary">
                  <div className="card-body">
                    <div className="row mb-3">
                      <div className="col-auto"><span className="avatar avatar-md" style={{ backgroundImage: "url(../static/avatars/003m.jpg)" }}> </span></div>
                      <div className="col">
                        <h3 className="h3 m-0">Dunn Slane</h3>
            ...
            <div className="row g-lg-6">
              <div className="col-12">
                <a href="#" className="card bg-surface-secondary">
                  <div className="card-body">
                    <div className="row mb-3">
                      <div className="col-auto"><span className="avatar avatar-md" style={{ backgroundImage: "url(../static/avatars/000f.jpg)" }}> </span></div>
                      <div className="col">
                        <h3 className="h3 m-0">Emmy Levet</h3>
              ...
              <div className="col-12">
                <a href="#" className="card bg-surface-secondary">
                  <div className="card-body">
                    <div className="row mb-3">
                      <div className="col-auto"><span className="avatar avatar-md" style={{ backgroundImage: "url(../static/avatars/001f.jpg)" }}> </span></div>
                      <div className="col">
                        <h3 className="h3 m-0">Maryjo Lebarree</h3>
                        <div className="text-secondary">Civil Engineer</div>
                      </div>
                    </div>
                    <p>What I love about Tabler is its sleek design and ease of use. It's really simplified my HTML designing work. Five stars from me!</p>
                  </div>
                </a>
              </div>
              <div className="col-12">
                <a href="#" className="card bg-surface-secondary">
                  <div className="card-body">
                    <div className="row mb-3">
                      <div className="col-auto"><span className="avatar avatar-md" style={{ backgroundImage: "url(../static/avatars/004m.jpg)" }}> </span></div>
                      <div className="col">
                        <h3 className="h3 m-0">Egan Poetz</h3>
                        <div className="text-secondary">Research Nurse</div>
                      </div>
                    </div>
                    <p>
                      I'd recommend Tabler to anyone, whether they're a seasoned pro or a beginner in HTML design. Its versatility and user-friendly nature make
            ...
            <div className="row g-lg-6">
              <div className="col-12">
                <a href="#" className="card bg-surface-secondary">
                  <div className="card-body">
                    <div className="row mb-3">
                      <div className="col-auto"><span className="avatar avatar-md" style={{ backgroundImage: "url(../static/avatars/002f.jpg)" }}> </span></div>
                      <div className="col">
                        <h3 className="h3 m-0">Kellie Skingley</h3>
              ...
              <div className="col-12">
                <a href="#" className="card bg-surface-secondary">
                  <div className="card-body">
                    <div className="row mb-3">
                      <div className="col-auto"><span className="avatar avatar-md" style={{ backgroundImage: "url(../static/avatars/003f.jpg)" }}> </span></div>
                      <div className="col">
                        <h3 className="h3 m-0">Christabel Charlwood</h3>
                        <div className="text-secondary">Tax Accountant</div>
                      </div>
                    </div>
                    <p>
                      With Tabler, designing HTML has never been more straightforward. The kit's sleek features and functionalities have taken my design work to
                      new heights.
                    </p>
                  </div>
                </a>
              ...
              <div className="col-12">
                <a href="#" className="card bg-surface-secondary">
                  <div className="card-body">
                    <div className="row mb-3">
                      <div className="col-auto"><span className="avatar avatar-md" style={{ backgroundImage: "url(../static/avatars/063m.jpg)" }}> </span></div>
                      <div className="col">
                        <h3 className="h3 m-0">Haskel Shelper</h3>
        ...
        <div className="row justify-content-lg-center">
          <div className="col-sm-6 col-lg-3">
            <div className="text-center">
              <h2 className="display-5 m-0 fw-bold">48</h2>
              <p className="text-secondary m-0">templates</p>
            </div>
          </div>
          <div className="col-sm-6 col-lg-3">
            <div className="text-center">
              <h2 className="display-5 m-0 fw-bold">12</h2>
              <p className="text-secondary m-0">years in business</p>
            </div>
          </div>
          <div className="col-sm-6 col-lg-3">
            <div className="text-center">
              <h2 className="display-5 m-0 fw-bold">2,5k+</h2>
              <p className="text-secondary m-0">copies sold</p>
            </div>
          </div>
          <div className="col-sm-6 col-lg-3">
            <div className="text-center">
              <h2 className="display-5 m-0 fw-bold">99%</h2>
        ...
        <div className="row g-xl-6">
          ...
          <div className="col-lg">
            <div className="space-y-5">
              <div>
                <div className="h3 mb-1">Can I use Tabler in commercial projects?</div>
                <div className="text-secondary">
                  Of course! Tabler is under MIT license, so you can confidently use it in commercial projects. However, remember to include a note that your
                  project uses Tabler.
                </div>
              </div>
              <div>
                <div className="h3 mb-1">How do I get notified of new Tabler versions?</div>
                <div className="text-secondary">You may watch the releases on GitHub or follow me on Twitter.</div>
              </div>
              <div>
                <div className="h3 mb-1">Can Tabler be used with WordPress?</div>
                <div className="text-secondary">
                  Tabler is an HTML template that can be used for any purpose. However, it is not made to be easily installed on WordPress. It will require some
                  effort and enough knowledge of the WordPress script to do so.
                </div>
              </div>
            </div>
            <div className="mt-5">
              <a className="btn" href="#">Read more questions</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer className="footer">
      <div className="container">
        <div className="py-3">
            ...
            <div className="col-lg-7">
              <div className="row g-lg-4">
                <div className="col-md">
                  <div className="subheader mb-3">Our products</div>
                  <ul className="list-unstyled list-separated gap-2">
                    <li><a className="link-secondary" href="">UI Kit</a></li>
                    <li>
                      <a className="link-secondary" href="">Open source icons</a>
                    </li>
                    <li>
                      <a className="link-secondary" href="">Email templates</a>
                    </li>
                    <li><a className="link-secondary" href="">Pricing</a></li>
                  </ul>
                </div>
                <div className="col-md">
                  <div className="subheader mb-3">Support</div>
                  <ul className="list-unstyled list-separated gap-2">
                    <li><a className="link-secondary" href="">Blog</a></li>
                    <li><a className="link-secondary" href="">Documentation</a></li>
                    <li><a className="link-secondary" href="">Support</a></li>
                    <li>
                      <a href="https://status.tabler.io" className="link-secondary" target="_blank" rel="noreferrer">Status</a>
                    </li>
                  </ul>
                </div>
                <div className="col-md">
                  <div className="subheader mb-3">Tabler</div>
                  <ul className="list-unstyled list-separated gap-2">
                    <li><a className="link-secondary" href="">About</a></li>
                    <li><a className="link-secondary" href="">Blog</a></li>
                    <li><a className="link-secondary" href="">Changelog</a></li>
                    <li>
                      <a href="https://github.com/tabler/tabler" className="link-secondary" target="_blank" rel="noreferrer">Github</a>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="row g-lg-4 justify-content-between mt-0 mt-md-2">
            <div className="col-sm-7 col-md-6 col-lg-4">
              <h5 className="subheader">Payment &amp; Security</h5>
              <ul className="list-inline mb-0 mt-3">
                <li className="list-inline-item">
                  <a href="#"><span className="payment payment-1 payment-provider-paypal"></span> </a>
                </li>
                <li className="list-inline-item">
                  <a href="#"><span className="payment payment-1 payment-provider-visa"></span> </a>
                </li>
                <li className="list-inline-item">
                  <a href="#"><span className="payment payment-1 payment-provider-mastercard"></span> </a>
                </li>
                <li className="list-inline-item">
                  <a href="#"><span className="payment payment-1 payment-provider-americanexpress"></span> </a>
                </li>
              </ul>
            </div>
            <div className="col-sm-5 col-md-6 col-lg-3 text-sm-end">
              <h5 className="subheader">Follow us on</h5>
              <ul className="list-inline mb-0 mt-3">
                <li className="list-inline-item">
                ...
                <li className="list-inline-item">
                  <a className="btn btn-icon btn-twitter" href="#"
                    >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
    ...
    <footer className="footer">
      <div className="container">
        <div className="py-3 border-top-light text-center text-lg-start">
          <div className="row g-lg-4">
            <div className="col-lg-auto text-lg-end order-lg-last">
              <div className="row justify-center">
                <div className="col-auto">©<a href="https://codecalm.net" className="link-secondary" target="_blank" rel="noopener noreferrer">codecalm.net</a></div>
                <div className="col-auto">
                  <ul className="list-inline list-inline-dots">
                    <li className="list-inline-item">
                      <a className="link-secondary" href="/terms-of-service">Terms of service</a>
                    </li>
                    <li className="list-inline-item">
            ...
            <div className="col-lg">
              ...
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="icon text-red icon-inline icon-4"
              >
